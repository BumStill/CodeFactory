...
-- application code. The same DDL is mirrored by
-- agent::objective::ensure_schema for defensive compatibility on historical
-- databases; migration version 6 belongs to session auto-title on main.
