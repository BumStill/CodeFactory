...
// jsdom doesn't implement Element.scrollTo and leaves scrollTop a no-op writer.
// We need both to work for the stick-to-bottom hook tests — without them the
// observer fires but setting scrollTop does nothing observable.
// Patch globally so every test gets a real scrollHeight/scrollTop pair.
